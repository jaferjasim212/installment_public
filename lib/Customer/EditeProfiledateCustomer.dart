...
class EditProfileDataCustomer extends StatefulWidget {
  const EditProfileDataCustomer({super.key});

  @override
  State<EditProfileDataCustomer> createState() => _EditProfileDataCustomerState();
}

class _EditProfileDataCustomerState extends State<EditProfileDataCustomer> with SingleTickerProviderStateMixin {
...
class _LoginSectionState extends State<_LoginSection> {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      final prefs = await SharedPreferences.getInstance();
      final userId = prefs.getString('CustomerUserID');
      if (userId == null) throw Exception('لم يتم العثور على CustomerUserID');
...
class _ProfileSectionState extends State<_ProfileSection> {
  ...
  Future<void> _loadUserData() async {
    final prefs = await SharedPreferences.getInstance();
    userId = prefs.getString('CustomerUserID');
    if (userId == null) {
