...
import 'package:installment/HomePage.dart';
  ...
  Future<void> _login() async {
    ...
    if (input.isNotEmpty && password.isNotEmpty) {
      try {
        ...
        if (userProfile == null) {
          throw Exception("هذا الحساب غير مسجل كتاجر.");
        }
              ...
              Stack(
                children: [
                  ...
                  Container(
                    ...
                    width: double.infinity,
                    child: Lottie.asset(
                      'assets/Animation/Animationbackgrund.json',
                      fit: BoxFit.cover,
                    ),
                  ),
                              ...
                              child: MaterialButton(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                        const EmailSignUpStep()), // إنشاء مسار جديد
                                  );
                                },
                                height: 50,
