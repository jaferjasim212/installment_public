...
import 'package:installment/news.dart';
    ...
    if (_isRotating) {
      Future.delayed(const Duration(milliseconds: 1000), () {
        if (mounted) {
          ...
          _showDelegateLoginSheet(context);
        }
      });
    }
  }
...
// وفي الـ GestureDetector:
  ...
  Widget build(BuildContext context) {
    return Directionality(
        ...
        children: [
          ...
          _buildSettingsOptionpay(context,"احصل على أقساط بريميوم ..","قم بترقية حسابك الان الى النسخة المدفوعة .."),
          ...
          if (_subscription != null)
            ...
            _buildLogoutOption("تبديل الى حساب المستخدم", Icons.swap_horiz, Colors.red),
  ...
  Widget _buildSettingsOptionpay(BuildContext context, String title, String subtitle) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // ✅ محتوى الكارد - في المنتصف تمامًا
            Container(
              height: 80,
              decoration: BoxDecoration(
              ...
              child: Center(
                child: Row(
                  ...
                  children: [
                    ...
                    // أيقونة النهاية
                    Lottie.asset(
                      'assets/Animation/Animationpayment.json',
                      height: 50,
                      fit: BoxFit.contain,
                    ),
                  ],
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          if (title == "التحويل على وضع المندوب") {
            _toggleRotation();
        }
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () async {
          ...
          if (title == "تبديل الى حساب المستخدم") {
            SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  void _showDelegateLoginSheet(BuildContext context) {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text("تسجيل دخول المندوب", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(height: 16),
                TextField(
                ...
                ScaleTransition(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text("دخول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16),),
                    style: ElevatedButton.styleFrom(
                    ...
                    onPressed: () async {
                      ...
                      if (delegate == null || delegate['password'] != password) {
                        Navigator.of(ctx).pop();
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text("❌ اسم المستخدم أو كلمة المرور خاطئة"),
                            behavior: SnackBarBehavior.floating,
                          ),
                        );
                        return;
                      ...
                      await prefs.setString('UserID', delegate['user_id']);
                      await prefs.setString('DelegateID', delegate['id'].toString());
                      await prefs.setBool('isDelegate', true);

                      Navigator.of(ctx).pop();
                      Navigator.pushAndRemoveUntil(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (context, animation, secondaryAnimation) => const DelegatesMonybaky(),
